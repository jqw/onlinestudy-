                            ...
                            '<div class="commentbox clearfix" >'+
                                ...
                                '<div class="comment-content2">' +
                                    '<div class="oldcomment">'+
                                        '<p class="comment-text"><span class="studyuser"><i>我评论</i>：</span>' + textareaval + '</p>' +
                    ...
                    success: function(data) {
                        if (data.id){
                            var textareaval = _self.parent('.replycommentbox').find('.replybox').val(),
                                ...
                                '<p class="comment-text"><span class="studyuser"><i>我</i> 回复 <i>'+ parentName +'</i>：</span>' + textareaval + '</p>' +
                                '<p class="comment-time">'+ Dml.fun.getDate() +'</p>' +
                    ...
                    if (data.id){
                        var evalbox =
                            '<div class="comment-box clearfix">'+
                                ...
                                '<p class="comment-text"><span class="studyuser"><i>我</i>' +' 回复 <i>'+ parentName +'</i>:</span>  '+ textareaval2 + '</p>' +
                                '<p class="comment-time">'+ Dml.fun.getDate() +'</p>' +
